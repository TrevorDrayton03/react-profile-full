...
const PetUniverse = () => {
    return (
        <div className="project" >
            ...
            <p><em>Login to the Admin page using trevor for the username and password. The first instance of the day can be very slow to start up.</em></p>
            <p>A final project for Web Applications (SOFT. ENG. 4620).</p>
            <div>
                ...
                <div>
                    Provide a platform for users to purchase pets and pet supplies online. It needs to be user-friendly, responsive, and robust, while allowing an admin to manage the content of the website from the frontend.
                </div>
                <h4>
                    Functions
                </h4>
                ...
                <div>
                    <ul>
                        <li>
                            Two person project with sizeable skill difference
                        </li>
                        <li>
                            Limited time
                        </li>
            ...
            <div>
                ...
                <ul>
                    <li>React class components (already knew functional)</li>
                    <li>UI Design Principles</li>
                    <li>MongoDB, Node, and Express</li>
                    <li>JSDoc</li>
